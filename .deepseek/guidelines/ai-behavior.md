---
paths: ["**/*"]
description: Universal AI execution guidelines for scoped, autonomous, evidence-driven DeepSeek work across stacks and domains.
when_to_use: Every DeepSeek task, regardless of stack or domain.
