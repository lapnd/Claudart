...
- [ ] P1.99 Private postgres test (verify: go test ./internal/adapters/postgres/...)
      node: test/private-pg | kind: test
      proves: adapter/postgres-user
      requires: port/user-repository (PORT)
      paths: internal/adapters/postgres/x_test.go
- [ ] P2.0 PostgreSQL adapter for UserRepository (verify: go test ./internal/adapters/postgres/...)
      ...
      requires: port/user-repository (PORT), test/private-pg (TEST)
