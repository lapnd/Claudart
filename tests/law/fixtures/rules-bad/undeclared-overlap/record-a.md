---
paths: ["src/**/*.go"]
description: Bad-case fixture — first of two records with overlapping paths and a shared tag.
...
# Bad Case — Undeclared Overlap (record A)

Overlaps `record-b.md`'s `paths` glob and shares the `undeclared-overlap-fixture` tag. Neither
