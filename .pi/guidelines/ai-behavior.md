---
paths: ["**/*"]
description: Universal AI execution guidelines for scoped, autonomous, evidence-driven Pi work across stacks and domains.
when_to_use: Every Pi task, regardless of stack or domain.
